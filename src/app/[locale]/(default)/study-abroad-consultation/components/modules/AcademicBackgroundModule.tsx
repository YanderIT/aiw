          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div
                ...
                onClick={() => (document.getElementById('graduation_date') as HTMLInputElement)?.showPicker?.()}
              >
                <Input
                  id="graduation_date"
                  type="month"
                  value={formData.graduation_date}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateAcademicBackground({ graduation_date: e.target.value })}
