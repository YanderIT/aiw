        ...
        <div className="flex flex-wrap gap-x-6 gap-y-2 items-center justify-start text-sm">
          ...
          {basics.location && (
            <div className="flex items-center gap-2">
              ...
              <h1 style={{ color: "#333333" }}>{basics.location}</h1>
            </div>
          )}
          ...
          {basics.phone && (
            <div className="flex items-center gap-2">
              ...
              <h1 style={{ color: "#333333" }}>{basics.phone}</h1>
            </div>
          )}
          ...
          {basics.email && (
            <div className="flex items-center gap-2">
              ...
              <h1 style={{ color: "#333333" }}>{basics.email}</h1>
            </div>
          )}
          ...
          {basics.url?.href && (
            <div className="flex items-center gap-2">
              ...
              <h1 style={{ color: "#333333" }}>{basics.url.href}</h1>
            </div>
          )}
        </div>
      </div>
