# Privacy Policy for 智写匠

## Introduction

Welcome to 智写匠, the **NextJS Boilerplate** designed to help you build AI SaaS startups quickly and efficiently. At 智写匠, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using 智写匠:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use 智写匠, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access 智写匠, such as device type, operating system, and browser type.
...
**Copyright Owner**: [智写匠.ai](http://智写匠.ai)
**Email**: [support@智写匠.ai](mailto:support@智写匠.ai)

By using 智写匠, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
