...
Welcome to **智写匠**, a NextJS boilerplate designed for building AI SaaS startups quickly and efficiently. By accessing or using our service, you agree to be bound by these Terms of Service. If you do not agree with any of these terms, please do not use our service.

## Use of the Service

智写匠 provides users with a comprehensive platform to build and launch AI SaaS startups using our pre-built templates and infrastructure. You agree to use the service in accordance with all applicable local, state, national, and international laws and regulations.
...
All content provided through 智写匠, including but not limited to templates, code, infrastructure setup, and documentation, is protected under copyright law. The copyright owner of 智写匠 is **智写匠.ai**.

- You acknowledge that you do not own the underlying technology or intellectual property that makes up the 智写匠 service, and you agree to respect the intellectual property rights of 智写匠.ai and any third parties.
- While you retain ownership of your custom implementations and modifications, the core 智写匠 platform and templates remain the property of 智写匠.ai.

## Prohibited Activities

You agree not to engage in any of the following prohibited activities while using 智写匠:

- Unauthorized access to or distribution of our proprietary code and templates
- Reselling or redistributing 智写匠 templates without authorization
...
智写匠 collects the following types of data:
...
To the fullest extent permitted by law, 智写匠.ai shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from the use of or inability to use the service.

## Indemnification

You agree to indemnify and hold harmless 智写匠.ai, its affiliates, and their respective officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorneys' fees) arising from your use of the service or violation of these Terms.

## Governing Law and Dispute Resolution

These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which 智写匠.ai operates, without regard to its conflict of law provisions. Any disputes arising from these Terms or the service will be resolved through binding arbitration in accordance with applicable laws.
...
If you have any questions about these Terms, please contact us at [support@智写匠.ai](mailto:support@智写匠.ai).

---

By using 智写匠, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. Thank you for choosing 智写匠!
