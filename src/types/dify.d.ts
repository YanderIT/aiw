...
// 功能类型定义
export type DifyFunctionType = 'recommendation-letter' | 'cover-letter' | 'resume-generator' | 'sop' | 'revise-sop' | 'personal-statement' | 'revise-personal-statement' | 'revise-cover-letter' | 'default';
